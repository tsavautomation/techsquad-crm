...
| **M12** | **Dashboards + admin.** Per-module dashboard (My Assigned, My Tasks, Recently Modified); admin screens: users ↔ groups, **editable permission matrix**, utility lists, automations; **permission review session with Fred** (several WebAuthor grants need adjusting) | manage users without me | admins can do everything SPEC §7 gives them |
