...
- `npm run db:test-rls` (40 permission checks) and `npm run db:test-workflows` (34 workflow checks) run against dev and are fully rolled back. Run both after any change to policies, permissions or workflows.
